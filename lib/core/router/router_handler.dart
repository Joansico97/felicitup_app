...
Page<Widget> _homeHandler(
  ...
  return CustomTransitionPage(
    ...
    child: MultiBlocProvider(
      ...
      child: HomePage(childView: child),
    ),
    transitionDuration: Duration(milliseconds: 500),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      const begin = Offset(1.0, 0.0);
...
Page<Widget> _onBoardingHandler(BuildContext context, GoRouterState state) {
  return CustomTransitionPage(
    child: BlocProvider(
...
Page<Widget> _frequentQuestionsHandler(
  BuildContext context,
  GoRouterState state,
) {
  return CustomTransitionPage(
    child: BlocProvider(
      create: (_) => injection.di<FrequentQuestionsBloc>(),
      child: FrequentQuestionsPage(),
    ),
    transitionDuration: Duration(milliseconds: 500),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      const begin = Offset(1.0, 0.0);
...
Page<Widget> _phoneVerifyIntHandler(BuildContext context, GoRouterState state) {
  return CustomTransitionPage(
    child: BlocProvider(
      create: (_) => injection.di<PhoneVerifyIntBloc>(),
      child: PhoneVerifyIntPage(),
    ),
    transitionDuration: Duration(milliseconds: 500),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      const begin = Offset(1.0, 0.0);
...
Page<Widget> _detailsPastFelicitupDashboardHandler(
  ...
  return CustomTransitionPage(
    ...
    child: MultiBlocProvider(
      ...
      child: DetailsPastFelicitupDashboardPage(childView: child),
    ),
    transitionDuration: Duration(milliseconds: 500),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      const begin = Offset(1.0, 0.0);
