...
class PeoplePastFelicitupMobilePage extends StatefulWidget {
  const PeoplePastFelicitupMobilePage({super.key});

  @override
  State<PeoplePastFelicitupMobilePage> createState() =>
      _PeoplePastFelicitupMobilePageState();
}

class _PeoplePastFelicitupMobilePageState
    extends State<PeoplePastFelicitupMobilePage> {
  @override
  void initState() {
    super.initState();
