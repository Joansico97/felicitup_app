...
class PeoplePastFelicitupEvent with _$PeoplePastFelicitupEvent {
  ...
  const factory PeoplePastFelicitupEvent.loadFriendsData(
    List<String> usersIds,
  ) = _loadFriendsData;
  const factory PeoplePastFelicitupEvent.startListening(String felicitupId) =
      _startListening;
  const factory PeoplePastFelicitupEvent.recivedData(
