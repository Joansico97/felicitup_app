...
class ChatPastFelicitupEvent with _$ChatPastFelicitupEvent {
  const factory ChatPastFelicitupEvent.asignCurrentChat(String chatId) =
      _asignCurrentChat;
  ...
  const factory ChatPastFelicitupEvent.startListening(String chatId) =
      _startListening;
  const factory ChatPastFelicitupEvent.recivedData(
