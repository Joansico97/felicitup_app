...
class ChatPastFelicitupMobilePage extends StatefulWidget {
  const ChatPastFelicitupMobilePage({super.key});

  @override
  State<ChatPastFelicitupMobilePage> createState() =>
      _ChatPastFelicitupMobilePageState();
}

class _ChatPastFelicitupMobilePageState
    extends State<ChatPastFelicitupMobilePage>
  ...
  void deleteId() {
    if (context.mounted) {
      context.read<ChatPastFelicitupBloc>().add(
            const ChatPastFelicitupEvent.asignCurrentChat(''),
          );
    }
  }
