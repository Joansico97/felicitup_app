...
class BoteFelicitupMobilePage extends StatefulWidget {
  const BoteFelicitupMobilePage({super.key});

  @override
  State<BoteFelicitupMobilePage> createState() =>
      _BoteFelicitupMobilePageState();
}

class _BoteFelicitupMobilePageState extends State<BoteFelicitupMobilePage> {
  ...
  void initState() {
    ...
    detailsFelicitupNavigatorKey.currentContext!
        .read<DetailsFelicitupDashboardBloc>()
        .add(const DetailsFelicitupDashboardEvent.changeCurrentIndex(4));
