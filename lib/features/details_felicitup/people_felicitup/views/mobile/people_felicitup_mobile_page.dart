        ...
        builder: (_, peopleState) {
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                Container(
                  margin: EdgeInsets.all(context.sp(12)),
                  child: TextField(
...
class PeopleFelicitupMobilePage extends StatefulWidget {
  const PeopleFelicitupMobilePage({super.key});

  @override
  State<PeopleFelicitupMobilePage> createState() =>
      _PeopleFelicitupMobilePageState();
}

class _PeopleFelicitupMobilePageState extends State<PeopleFelicitupMobilePage> {
  ...
  void initState() {
    ...
    detailsFelicitupNavigatorKey.currentContext!
        ...
        .add(const DetailsFelicitupDashboardEvent.changeCurrentIndex(2));
