...
class VideoFelicitupMobilePage extends StatefulWidget {
  const VideoFelicitupMobilePage({super.key});

  @override
  State<VideoFelicitupMobilePage> createState() =>
      _VideoFelicitupMobilePageState();
}

class _VideoFelicitupMobilePageState extends State<VideoFelicitupMobilePage> {
  @override
  void initState() {
    super.initState();
    ...
    detailsFelicitupNavigatorKey.currentContext!
        .read<DetailsFelicitupDashboardBloc>()
        .add(const DetailsFelicitupDashboardEvent.changeCurrentIndex(3));
