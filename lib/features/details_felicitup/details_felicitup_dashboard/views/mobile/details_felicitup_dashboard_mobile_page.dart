...
class DetailsFelicitupDashboardMobilePage extends StatefulWidget {
  const DetailsFelicitupDashboardMobilePage({
    super.key,
  ...
  @override
  State<DetailsFelicitupDashboardMobilePage> createState() =>
      _DetailsFelicitupDashboardMobilePageState();
}

class _DetailsFelicitupDashboardMobilePageState
    extends State<DetailsFelicitupDashboardMobilePage> {
  @override
  void initState() {
    super.initState();
  ...
  final List<Widget> pagesWithoutBote = const [
    InfoFelicitupPage(),
    MessageFelicitupPage(),
    PeopleFelicitupPage(),
    VideoFelicitupPage(),
  ...
  List<IconData> iconsWithoutBote = const [
    Icons.person_outline,
    Icons.chat_outlined,
    Icons.people_outline,
    Icons.camera_alt_outlined,
  ...
  List<IconData> selectedIconsWithoutBote = const [
    Icons.person,
    Icons.chat,
    Icons.people,
    Icons.camera_alt,
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: BlocBuilder<DetailsFelicitupDashboardBloc,
                                ...
                                (index) => IconButton(
                                  onPressed: () async {
                                    detailsFelicitupNavigatorKey
                                        ...
                                        .read<DetailsFelicitupDashboardBloc>()
                                        .add(
                                          DetailsFelicitupDashboardEvent
                                    ...
                                    switch (index) {
                                      case 0:
                                        ...
                                        context
                                            ...
                                            .add(
                                              const DetailsFelicitupDashboardEvent
                                                  .asignCurrentChat(''),
                                            );
                                        break;
                                      case 1:
