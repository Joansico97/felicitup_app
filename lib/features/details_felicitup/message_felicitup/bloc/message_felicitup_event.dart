...
class MessageFelicitupEvent with _$MessageFelicitupEvent {
  ...
  const factory MessageFelicitupEvent.asignCurrentChat(String chatId) =
      _asignCurrentChat;
  ...
  const factory MessageFelicitupEvent.setCurrentChatId(String chatId) =
      _setCurrentChatId;
  const factory MessageFelicitupEvent.startListening(String chatId) =
      _startListening;
  const factory MessageFelicitupEvent.recivedData(
