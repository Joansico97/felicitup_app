...
class SingleChatMobilePage extends StatefulWidget {
  const SingleChatMobilePage({super.key, required this.data});

  final SingleChatModel data;

  @override
  State<SingleChatMobilePage> createState() => _SingleChatMobilePageState();
}

class _SingleChatMobilePageState extends State<SingleChatMobilePage>
