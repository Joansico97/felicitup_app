...
class SingleChatWebPage extends StatefulWidget {
  const SingleChatWebPage({super.key, required this.data});

  final SingleChatModel data;

  @override
  State<SingleChatWebPage> createState() => _SingleChatWebPageState();
}

class _SingleChatWebPageState extends State<SingleChatWebPage> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: SizedBox(
            width: context.sp(650),
            height: context.sp(700),
            child: Container(
