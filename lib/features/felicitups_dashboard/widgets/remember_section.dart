  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AppBloc, AppState>(
      builder: (context, stateApp) {
        final isCollapsed = stateApp.isRememberSectionCollapsed;

        return FadeInDownBig(
          child: GestureDetector(
            onTap: () {
              context.read<AppBloc>().add(
                const AppEvent.toggleRememberSectionCollapsed(),
              );
            },
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: context.colors.white.withAlpha((.4 * 255).toInt()),
                border: Border.all(color: context.colors.white, width: context.sp(2)),
              ),
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => context.read<AppBloc>().add(
                          const AppEvent.closeRememberSection(),
                        ),
                        child: Container(
                          padding: EdgeInsets.all(context.sp(4)),
                          alignment: Alignment.center,
                  ...
                  Visibility(
                    ...
                    child: Builder(
                      builder: (_) {
                        final currentUser = stateApp.currentUser;
