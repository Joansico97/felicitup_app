...
class VideoEditorMobilePage extends StatefulWidget {
  const VideoEditorMobilePage({
    super.key,
  ...
  @override
  State<VideoEditorMobilePage> createState() => _VideoEditorMobilePageState();
}

class _VideoEditorMobilePageState extends State<VideoEditorMobilePage>
  ...
  void initState() {
    ...
    if (widget.videoUrl.isNotEmpty) {
      ...
      context.read<VideoEditorBloc>().add(const VideoEditorEvent.setUrlVideo(''));
    }
    super.initState();
  }
  ...
  void dispose() {
    ...
    if (context.mounted) {
      context.read<VideoEditorBloc>().add(
            const VideoEditorEvent.disposeVideoController(),
          );
    }
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: SecondaryButton(
                              onTap: () => context.read<VideoEditorBloc>().add(
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () {
                    context.read<VideoEditorBloc>().add(
                          const VideoEditorEvent.changeFullScreen(),
                        );
                  },
                  child: Container(
                    height: context.sp(30),
