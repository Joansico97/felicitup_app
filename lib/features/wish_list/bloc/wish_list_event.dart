...
class WishListEvent with _$WishListEvent {
  ...
  const factory WishListEvent.setProductName(String productName) =
      _setProductName;
  const factory WishListEvent.setProductDescription(String productDescription) =
      _setProductDescription;
  const factory WishListEvent.setProductPrice(String productPrice) =
      _setProductPrice;
  ...
  const factory WishListEvent.editGiftItemInfo(GiftcarModel item) =
      _editGiftItemInfo;
  const factory WishListEvent.deleteGiftItemInfo(String id) =
      _deleteGiftItemInfo;
  const factory WishListEvent.startListening() = _startListening;
  const factory WishListEvent.recivedData(List<GiftcarModel> listGiftcard) =
      _recivedData;
}
