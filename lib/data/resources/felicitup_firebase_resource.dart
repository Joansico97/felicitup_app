...
import 'package:felicitup_app/data/models/felicitup_models/owner_model/owner_model.dart';
...
class FelicitupFirebaseResource implements FelicitupRepository {
  ...
  @override
  Future<Either<ApiException, void>> deleteFelicitup(String felicitupId) async {
    try {
  ...
  Future<Either<ApiException, void>> updateFelicitupOwner(
    ...
    try {
      ...
      final ownersList = felicitupData['owner'] as List<dynamic>? ?? [];
  ...
  Future<Either<ApiException, void>> reportUserVideo(
    ...
    try {
      await _databaseHelper
          .set(AppConstants.reportedVideosCollection, document: felicitupId, {
            'felicitupId': felicitupId,
            'videoUrl': videoUrl,
            'userId': userId,
